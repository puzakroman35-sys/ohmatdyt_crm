...
ssh rpuzak@192.168.31.249 "docker ps --format 'table {{.Names}}\t{{.Status}}\t{{.Ports}}'"

Write-Host ""
Write-Host "[2] Frontend logs (last 50 lines)..." -ForegroundColor Yellow
ssh rpuzak@192.168.31.249 "docker logs ohmatdyt_crm-frontend-1 --tail 50"

Write-Host ""
Write-Host "[3] Testing HTTPS..." -ForegroundColor Yellow
ssh rpuzak@192.168.31.249 "curl -k -I https://192.168.31.249/ 2>&1 | head -20"

Write-Host ""
Write-Host "===================================" -ForegroundColor Green
Write-Host "  Open in browser:" -ForegroundColor Green
Write-Host "  https://192.168.31.249/" -ForegroundColor Cyan
Write-Host "===================================" -ForegroundColor Green
