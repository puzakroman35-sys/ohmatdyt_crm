...
На продакшен сервері (https://192.168.31.248) логін-форма надсилала запити на `http://localhost:8000/auth/login` замість правильного URL `https://192.168.31.248/api/auth/login`, що призводило до CORS помилок та неможливості увійти в систему.
...
✅ Логін працює коректно через https://192.168.31.248/login  
✅ Немає CORS помилок  
